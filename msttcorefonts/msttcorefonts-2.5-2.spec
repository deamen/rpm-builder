...
Packager: Song Tang <deamen@gmail.com>
...
# this is the sourceforge mirrorlist as of 2024-02-05. If someone spots changes
# over at sourceforge, feel free to email me and I'll update the list
mirrors="altushost-swe+cfhcable+cytranet+deac-ams+deac-fra+deac-riga+excellmedia+freefr+gox+ixpeering+jaist+kumisystems+liquidtelecom+nchc+netactuate+netcologne+netix+newcontinuum+phoenixnap+pilotfiber+psychz+razaoinfo+sinalbr+sitsa+tenet+ufpr+unlimited+versaweb+webwerks+yer+zenlayer"
mirror_count=31
...
function set_mirror {
        ...
        mirror="https://${m}.dl.sourceforge.net/project/corefonts/the%20fonts/final/"
}
...
%changelog
* Wed Feb 07 2024 Song Tang <deamen@gmail.com> 2.5-2
- Update the sourceforge mirrorlist
- Use https for sourceforge download
